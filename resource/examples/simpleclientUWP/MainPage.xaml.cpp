...
void simpleclientUWP::MainPage::ClearFoundText()
{
    Dispatcher->RunAsync(Windows::UI::Core::CoreDispatcherPriority::Normal,
...
void simpleclientUWP::MainPage::ShowResultText(Platform::String^ msg)
{
    Dispatcher->RunAsync(Windows::UI::Core::CoreDispatcherPriority::Normal,
        ref new Windows::UI::Core::DispatchedHandler([this, msg]()
    {
...
void simpleclientUWP::MainPage::ClearResultText()
{
    Dispatcher->RunAsync(Windows::UI::Core::CoreDispatcherPriority::Normal,
        ref new Windows::UI::Core::DispatchedHandler([this]()
    {
    ...
    Windows::UI::Xaml::RoutedEventArgs^ e)
{
    ...
    std::thread asyncThread(clientThread);
    asyncThread.detach();
}
